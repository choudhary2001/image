...
from authy.views import UserProfile, Signup, PasswordChange, PasswordChangeDone, EditProfile, Editachivement, addachivement
...
urlpatterns = [
	...
	path('profile/editachivement/<id>/', Editachivement, name='edit-achivement'),
	path('profile/addachivement/', addachivement, name='add-achivement'),
